namespace LATIENDA.Web.API.Migrations
{
    ...
    public partial class Semodificaronalgunasclases : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        LineadeVenta_ID = c.Int(),
                        Pago_ID = c.Int(),
                        Usuario_ID = c.Int(),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.Cliente", t => t.Cliente_ID)
                .ForeignKey("dbo.Comprobante", t => t.Comprobante_ID)
                .ForeignKey("dbo.LineadeVenta", t => t.LineadeVenta_ID)
                .ForeignKey("dbo.Pago", t => t.Pago_ID)
                .ForeignKey("dbo.Usuarios", t => t.Usuario_ID)
                .Index(t => t.Cliente_ID)
                .Index(t => t.Comprobante_ID)
                .Index(t => t.LineadeVenta_ID)
                .Index(t => t.Pago_ID)
