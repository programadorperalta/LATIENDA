namespace LATIENDA.Web.API.Migrations
{
    ...
    public partial class Modificacion21032022515PM : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.Productos", "Marca_ID", c => c.Int());
            AlterColumn("dbo.Productos", "Rubro_ID", c => c.Int());
            AlterColumn("dbo.Productos", "TipodeTalle_ID", c => c.Int());
        ...
        public override void Down()
        {
            ...
            AlterColumn("dbo.Productos", "TipodeTalle_ID", c => c.Int(nullable: false));
            AlterColumn("dbo.Productos", "Rubro_ID", c => c.Int(nullable: false));
            AlterColumn("dbo.Productos", "Marca_ID", c => c.Int(nullable: false));
